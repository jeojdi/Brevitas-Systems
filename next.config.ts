...
const nextConfig: NextConfig = {
  ...
  async rewrites() {
    return {
      ...
      beforeFiles: [
        ...
        { source: '/bvx', destination: '/bvx.html' },
        { source: '/for-enterprises', destination: '/for-enterprises.html' },
        ...
        { source: '/blog/splice-kv-cache-editing', destination: '/splice-kv-cache-editing.html' },
        { source: '/blog/splice-rerotation', destination: '/splice-rerotation.html' },
        { source: '/blog/splice-repair', destination: '/splice-repair.html' },
        { source: '/blog/splice-certificate', destination: '/splice-certificate.html' },
  ...
  async redirects() {
    return [
      ...
      { source: '/bvx.html', destination: '/bvx', permanent: true },
      { source: '/for-enterprises.html', destination: '/for-enterprises', permanent: true },
      ...
      { source: '/splice-kv-cache-editing.html', destination: '/blog/splice-kv-cache-editing', permanent: true },
      { source: '/splice-rerotation.html', destination: '/blog/splice-rerotation', permanent: true },
      { source: '/splice-repair.html', destination: '/blog/splice-repair', permanent: true },
      { source: '/splice-certificate.html', destination: '/blog/splice-certificate', permanent: true },
