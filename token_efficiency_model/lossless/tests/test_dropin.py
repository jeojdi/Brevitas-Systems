...
def test_savings_report_anthropic_with_cache():
    ...
    # Output is never cached and is billed at full price, so the honest total-bill
    # savings includes it (see savings_from_usage docstring):
    #   uncached = (1000 fresh + 5000 read)*1.0 + 100 out*5.0 = 6500
    #   actual   = 1000*1.0 + 5000*0.10 + 100*5.0             = 2000
    #   savings  = 1 - 2000/6500 = 69.23%
    assert 65 < report.savings_pct < 75
